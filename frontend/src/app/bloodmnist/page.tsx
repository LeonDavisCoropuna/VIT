            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    { src: '/blood/confusion-matrix.png', alt: 'Matriz de Confusión', title: 'Matriz de Confusión' },
                    { src: '/blood/metrics-class.png', alt: 'Métricas por Clase', title: 'Métricas por Clase' },
                    { src: '/blood/loss-curve.png', alt: 'Curva de Pérdida', title: 'Curva de Pérdida' },
                    { src: '/blood/accuracy-curve.png', alt: 'Curva de Precisión', title: 'Curva de Precisión' },
                  ].map((image, index) => (
                    <Dialog key={index}>
